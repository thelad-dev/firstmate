...
`prime` is not a verified harness in this tree: `kunchenguid/firstmate#1966` was closed unmerged as of 2026-08-18, and `bin/fm-harness.sh` does not list it.
A native Cursor-as-Prime-model provider (CLI spawn, not a Firstmate harness) lives at `thelad-dev/prime-agent-cursor-provider`; see [`docs/verification/prime-cursor-provider.md`](../../../docs/verification/prime-cursor-provider.md).
